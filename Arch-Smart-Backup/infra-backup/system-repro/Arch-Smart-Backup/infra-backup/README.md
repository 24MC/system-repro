⚠️ Pacman repository configuration is intentionally NOT backed up or restored.

This tool assumes a modern Arch Linux system where [community] has been merged into [extra].
